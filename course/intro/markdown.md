...
Шаблон Service Discovery на стороне сервера (Server-Side Service Discovery) позволяет клиентам взаимодействовать с сервисами без необходимости самостоятельно управлять процессом их обнаружения и балансировки нагрузки. Вместо этого, эти задачи возлагаются на центральный компонент, такой как сервер балансировки нагрузки или шлюз API<!-- .element: class="left" -->
