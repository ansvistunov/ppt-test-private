...
- плюсы
 ...
 - минусы
    - более сложный клиент, который **знает** внутреннюю стуктуру сервиса, и которому необходимо **доверить** стратегию балансировки
...
### Балансировщик (важные замечания)
 ...
 - cостав серверов может изменяться во времени (Service Discovery)
...
Для определения шарда используется понятие **ключа шардирования**. В качестве ключа могут использоваться:
 ...
 - или любое другое *простое* правило, которое позволит по елементу данных определить его шард
